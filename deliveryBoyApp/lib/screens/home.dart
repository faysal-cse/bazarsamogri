...
class _HomeState extends State<Home> {
  ...
  AppBar buildAppBar(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        LangText(context).local?.dashboard_ucf ?? 'Dashboard',
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          padding: const EdgeInsets.only(top: 15.0),
                          child: Text(
                            LangText(context).local?.earnings_ucf ?? 'Earnings',
                            style: TextStyle(color: Colors.grey.shade300),
                          ),
                        ),
                        Padding(
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    ...
                    child: Text(
                      "${LangText(context).local?.on_the_way_ucf ?? 'On The Way'} ($_on_the_way)",
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 8),
                    child: Text(
                      "${LangText(context).local?.picked_ucf ?? 'Picked'} ($_picked)",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 14,
                          color: MyTheme.golden,
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.only(top: 8),
                    child: Text(
                      "${LangText(context).local?.assigned ?? 'Assigned'} ($_assigned)",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                          fontSize: 14,
                          color: MyTheme.blue,
