...
class _OfflineState extends State<Offline> {
  ...
  buildBody(context){
    final screen_width = MediaQuery.of(context).size.width * (3/4);
          ...
          child: Column(
            children: [
              Padding(padding: const EdgeInsets.only(top: 40,),
                 child: SizedBox(width:75,child: Image.asset("assets/delivery_app_logo.png")),
              ),
              Padding(padding: const EdgeInsets.only(top: 80,),
                child: SizedBox(width:120,child: Image.asset("assets/offline_cloud.png")),
              ),
              Padding(padding: const EdgeInsets.only(top: 40,),
