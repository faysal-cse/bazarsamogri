...
class _SplashState extends State<Splash> {
  ...
  void initState() {
    ...
    // Navigate after 3 seconds or after the future resolves
    _navigateToNextScreen();
  }

  @override
  void dispose() {
    // Restore status bar before transitioning to the next screen
    SystemChrome.setEnabledSystemUIMode(SystemUiMode.manual,
  ...
  //   await Future.delayed(Duration(seconds: 3)); // Simulate initialization delay
  //   if (OneContext.hasContext) {
  //     OneContext().pushReplacement(MaterialPageRoute(builder: (_) => Main()));
  //   } else {
    ...
    return Scaffold(
      body: Stack(
        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              color: MyTheme.splash_login_screen_color,
            ),
          ),
          Column(
            mainAxisAlignment: MainAxisAlignment.center,
